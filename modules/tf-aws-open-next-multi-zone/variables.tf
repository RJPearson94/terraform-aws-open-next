...
See https://github.com/RJPearson94/terraform-aws-open-next/tree/v3.0.0?tab=readme-ov-file#deployment-options for a complete breakdown of the different deployment options.
...
See https://github.com/RJPearson94/terraform-aws-open-next/blob/v3.0.0/docs/backend-server-deployments.md for a complete breakdown of the different backend options.
...
The module has a local copy of the x-forwarded host CloudFront function code by default. The code can be seen at https://github.com/RJPearson94/terraform-aws-open-next/blob/v3.0.0/modules/tf-aws-open-next-public-resources/code/xForwardedHost.js (open next v2) and https://github.com/RJPearson94/terraform-aws-open-next/blob/v3.0.0/modules/tf-aws-open-next-public-resources/code/cloudfrontFunctionOpenNextV3.js (open next v3). 
...
The module has a local copy of the auth function code, which will be deployed by default. The code can be seen at https://github.com/RJPearson94/terraform-aws-open-next/blob/v3.0.0/modules/tf-aws-open-next-public-resources/code/auth/index.js. You can override this to supplying a zip file containing the lambda code with either a local reference or a reference to the zip in an S3 bucket.
...
See https://github.com/RJPearson94/terraform-aws-open-next/blob/v3.0.0/docs/domain-config.md for a complete breakdown of the different domain configuration options. 
...
See https://github.com/RJPearson94/terraform-aws-open-next/blob/v3.0.0/docs/continuous-deployments.md for a complete breakdown of how to use continuous deployment. 
